...
import com.feng.android.common.util.ShellUtils.CommandResult;
...
public final class PackageUtils {
     ...
     * @param context
     * @param packageName
     * @since android.provider.Settings#ACTION_APPLICATION_DETAILS_SETTINGS requires API level 9 (current min is 8):
     */
